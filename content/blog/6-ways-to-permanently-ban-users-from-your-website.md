...
When you add a user’s unique visitor ID to a ban list with FingerprintJS, it’s difficult for them to circumvent it unless they frequently switch devices. FingerprintJS Pro is a free service for up to 20,000 API calls  per month - you can [sign up](https://dashboard.fingerprintjs.com/signup/) with no credit card required. 
