  ...
  return (
    <div className={styles.wrapper}>
      ...
      <Column title={'On-Demand'}>
        <Price
          value={customCount === undefined
            ? calculatePrice(selectedPreset.value, PaymentType.monthly)
            : calculatePrice(customCount >= minimumIdentifications ? customCount : minimumIdentifications, PaymentType.monthly)}
      ...
      <Column title={'Reserved'}>
        <Price
          value={customCount === undefined
            ...
            : calculatePrice(customCount >= minimumIdentifications ? customCount : minimumIdentifications, PaymentType.annually)}
