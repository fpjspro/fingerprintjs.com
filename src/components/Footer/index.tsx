      ...
      <Container size='large'>
        <nav className='nav nav--footer'>
              ...
              return (
                <div key={title} className='menu'>
                  ...
                  {links.map(({ title, url, isLocal }) => {
                    return isLocal ? (
                      <Link className='menu__link' key={url} to={url} target='_blank' rel='noopener'>
                        {title}
                      </Link>
                    ) : (
                      <a className='menu__link' key={url} href={url} target='_blank' rel='noopener'>
                        {title}
                      </a>
                    )
                  })}
          ...
          <div className='contact'>
            <div className='contact__title'>FingerprintJS</div>
            <address className='contact__address'>
              1440 W. Taylor St #735, Chicago, IL 60607, USA
              <br />
              <br />
              <a href="javascript:location='mailto:\u0073\u0075\u0070\u0070\u006f\u0072\u0074\u0040\u0066\u0069\u006e\u0067\u0065\u0072\u0070\u0072\u0069\u006e\u0074\u006a\u0073\u002e\u0063\u006f\u006d';void 0">
        ...
        <div className='copyrights'>&copy; 2020 FingerprintJS, Inc</div>
      </Container>
    </footer>
  )
}
