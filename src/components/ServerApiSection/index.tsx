        ...
        <header className='section-header'>
          ...
          <div className='tools-integrations'>
            <div className='tools-integrations-item'>
              ...
              <h3 className='tools-integrations-item__title'>&gt; Server-side visitor history API</h3>
              <p className='tools-integrations-item__description'>
                Access suspicious visitor activity, bot probability and geolocation at lightspeed. Integrate our API
                into your server-side business rules or signup process.
              </p>
            </div>
            <div className='tools-integrations-item'>
              <div className='tools-integrations-item__icon-container'>
              ...
              <h3 className='tools-integrations-item__title'>&gt; Webhooks for flexible workflows</h3>
              <p className='tools-integrations-item__description'>
